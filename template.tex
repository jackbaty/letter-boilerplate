...
\IfFileExists{/Users/jbaty/.pandoc/graphics/signature.pdf}
{
    \begin{FlushRight}
      \includegraphics[height=5.5\baselineskip]{/Users/jbaty/.pandoc/graphics/signature.pdf} \par
      $author$
    \end{FlushRight}
}
